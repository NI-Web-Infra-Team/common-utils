...
describe("CoordinateUtils", () => {
  ...
  test("09转84", () => {
    ...
    expect(lonlat).toEqual({
      lng: 116.39138609744414,
      lat: 39.907255434216694,
    });
  });
  test("84转09", () => {
